        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-2 text-sm text-primary-foreground/60">
              <div className="flex items-center gap-2">
                ...
                <a
                  href="https://www.leadzapmarketing.com.my"
                  target="_blank"
              ...
              <div className="flex items-center gap-2">
                <Globe className="h-4 w-4 text-accent" />
                <a
                  href="https://www.leadzapmarketing.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary-foreground"
                >
                  www.leadzapmarketing.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/60">
              ...
              <li>
                <a href="#packages" className="hover:text-primary-foreground">
                  Packages
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/60">
              <li>
                <a href="#delivery" className="hover:text-primary-foreground">
                  How We Work
                </a>
              </li>
              <li>
